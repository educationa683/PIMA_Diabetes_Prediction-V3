...
model_path = hf_hub_download(repo_id="LearnGenAI765/PIMA-Diabetes-Prediction-V3", filename="best_pima_diabetes_model_v1.joblib")                                       # enter the Hugging Face username here

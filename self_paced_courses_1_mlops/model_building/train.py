...
Xtrain_path = "hf://datasets/LearnGenAI765/PIMA-Diabetes-Prediction-V3/Xtrain.csv"                    # enter the Hugging Face username here
Xtest_path = "hf://datasets/LearnGenAI765/PIMA-Diabetes-Prediction-V3/Xtest.csv"                      # enter the Hugging Face username here
ytrain_path = "hf://datasets/LearnGenAI765/PIMA-Diabetes-Prediction-V3/ytrain.csv"                    # enter the Hugging Face username here
ytest_path = "hf://datasets/LearnGenAI765/PIMA-Diabetes-Prediction-V3/ytest.csv"                      # enter the Hugging Face username here
